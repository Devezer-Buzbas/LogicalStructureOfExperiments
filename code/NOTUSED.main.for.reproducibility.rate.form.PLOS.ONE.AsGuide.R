...
##
## @description 
# Population with Replicator, "Rey", to utilize information from replication studies
# under idealized study using the reproducibility rate
...
## PATHS
#############
 # Edit full path to the base directory TheoryOfReproducibility
baseDir <- "/home/erkan/Desktop/lab/Reproducibility/TheoryOfReproducibility" 
scriptDir <- paste0(baseDir, "/code") # code directory
...
for ( l in 1:L){
  ...
  # precision.
  name <- paste('/home/erkan/lab/Reproducibility/NoReplicator/data/ModelComparisonProbabilitiesSigma02AIC',l,'.RData', sep="")
  load(name)

  # SC
  Paic[[l]] <- ProbMC
  name <- paste('/home/erkan/lab/Reproducibility/NoReplicator/data/ModelComparisonProbabilitiesSigma02Schwarz',l,'.RData', sep="")
  load(name)
  Psc[[l]] <- ProbMC
}
#------------------------------------------------------------
